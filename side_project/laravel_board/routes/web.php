...
Route::middleware('my.user.validation')->post('/user/registration', [UserController::class, 'registrationpost'])->name('user.registration.post'); // 회원 가입 처리
...
//   GET|HEAD        board/{board}/edit ..... board.edit › BoardController@edit  v  6